...
<li>Ask: <code>Write a function to validate an email address.</code></li>
<li>Ask the exact same prompt again.</li>
<li>Compare variable names, structure, and validation behavior.</li>
</ol>
</div>

<div class="checkpoint">
<label><input type="checkbox" class="checkpoint-check"> I asked the same prompt twice and observed inconsistency.</label>
</div>
